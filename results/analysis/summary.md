...
Runs: 23; eligible: 12; excluded: 11.
Matched contrasts: 6; pairing issues: 0.
...
- jubias / jigsaw-unintended-bias-in-toxicity-classification / analogy vs baseline: mean effect **-0.009820**, n=6, 95% CI [-0.023730, +0.004091].
...
- jubias-pair-004 (analogy vs baseline): agent_model_unknown;best_pointer_differs_from_verified_optimum;budget_seconds_unknown;gpu_differs.
- jubias-pair-005 (analogy vs baseline): agent_model_unknown;best_pointer_differs_from_verified_optimum;budget_seconds_unknown;gpu_differs.
- jubias-pair-006 (analogy vs baseline): agent_model_unknown;budget_seconds_unknown;gpu_differs.
